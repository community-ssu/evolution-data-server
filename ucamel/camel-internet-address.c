...
static char *			camel_internet_address_encode_address(int *len, const char *name, const char *addr);
static char *			camel_internet_address_format_address(const char *real, const char *addr);
...
G_DEFINE_TYPE(CamelInternetAddress, camel_internet_address, camel_address_get_type())
