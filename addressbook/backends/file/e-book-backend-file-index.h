...
gboolean e_book_backend_file_index_setup_indicies (EBookBackendFileIndex *index, DB *db, const gchar *index_dirname);
...
void e_book_backend_file_index_remove_dbs (EBookBackendFileIndex *index);
