/*======================================================================
  ...
  $Id: icalvcal.c 596 2007-04-16 06:50:05Z rburton $
				 ...
				 int icaltype, icalvcal_defaults *defaults)
{
	...
	if (!attach_prop) {
	    ...
	    /* FIXME: This is broken on Win32. No idea whether this code
	     * ever is invoked in the context of Evolution, though.
	     * --tml@novell.com
	     */
	    if (url && url[0] == '/') {
		int len;
